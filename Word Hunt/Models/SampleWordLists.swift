...
struct SampleWordLists {
	...
	static var all: [WordList] { [
		...
		WordList(name: "Animals",
				 words: [
					"Albatross", "Alligator", "Antelope", "Baboon", "Badger", "Barracuda", "Bear", "Beaver", "Buffalo", "Camel", "Cheetah", "Chimpanzee", "Coyote", "Crocodile", "Deer", "Dolphin", "Donkey", "Elephant", "Ferret", "Flamingo", "Fox", "Giraffe", "Gorilla", "Hedgehog", "Hippopotamus", "Hyena", "Jaguar", "Kangaroo", "Koala", "Leopard", "Lion", "Llama", "Manatee", "Meerkat", "Moose", "Ocelot", "Ostrich", "Otter", "Panda", "Panther", "Pelican", "Penguin", "Platypus", "Rabbit", "Raccoon", "Rhinoceros", "Squirrel", "Tiger", "Walrus", "Zebra"]),
		
		WordList(name: "Colors",
				 words: [
					"Alabaster", "Amber", "Amethyst", "Apricot", "Aquamarine", "Azure", "Beige", "Black", "Blue", "Bronze", "Brown", "Burgundy", "Cerulean", "Charcoal", "Chartreuse", "Chestnut", "Cobalt", "Copper", "Coral", "Crimson", "Cyan", "Emerald", "Fuchsia", "Gold", "Gray", "Green", "Indigo", "Ivory", "Jade", "Lavender", "Lemon", "Magenta", "Maroon", "Mauve", "Mint", "Mustard", "Navy", "Ochre", "Olive", "Orange", "Peach", "Periwinkle", "Pink", "Plum", "Purple", "Red", "Ruby", "Salmon", "Scarlet", "Silver", "Tan", "Teal", "Turquoise", "Vermilion", "Violet", "White", "Yellow"]),
		...
		WordList(name: "Birds",
				 words: [
					"Albatross", "Buzzard", "Canary", "Cardinal", "Chickadee", "Condor", "Cormorant", "Crane", "Crow", "Dove", "Duck", "Eagle", "Falcon", "Finch", "Flamingo", "Goose", "Gull", "Hawk", "Heron", "Hummingbird", "Ibis", "Jay", "Kingfisher", "Kite", "Lark", "Loon", "Macaw", "Magpie", "Mallard", "Mockingbird", "Nightingale", "Ostrich", "Owl", "Parrot", "Pelican", "Penguin", "Pheasant", "Pigeon", "Quail", "Raven", "Robin", "Sparrow", "Stork", "Swallow", "Swan", "Toucan", "Vulture", "Warbler", "Woodpecker", "Wren"]),
		...
		WordList(name: "Flowers",
				 words: [
					"Begonia", "Bluebell", "Buttercup", "Camellia", "Carnation", "Chrysanthemum", "Clover", "Daffodil", "Dahlia", "Daisy", "Dandelion", "Gardenia", "Geranium", "Heather", "Hibiscus", "Hollyhock", "Honeysuckle", "Hyacinth", "Hydrangea", "Iris", "Juxta", "Jasmine", "Larkspur", "Lavender", "Lilac", "Lily", "Lotus", "Magnolia", "Marigold", "Mimosa", "Narcissus", "Oleander", "Orchid", "Pansy", "Peony", "Periwinkle", "Petunia", "Poppy", "Primrose", "Rhododendron", "Rose", "Rosemary", "Snapdragon", "Snowdrop", "Sunflower", "Sweetpea", "Thistle", "Tulip", "Violet", "Wisteria", "Zinnia"]),
